function tratarNome(n){
    ...
    aux = aux.trim();
        if(aux == null || aux == ""){
            document.getElementById(n).placeholder = "Nome necessário";
            document.getElementById(n).style.backgroundColor = "red";
        }else{
            document.getElementById(n).style.backgroundColor = "#6f5193cf";
...
function tratarEmail(n){
    let aux = document.getElementById(n).value; 
    if(aux == null || aux == ""){
        document.getElementById(n).placeholder = "Email necessário";
        document.getElementById(n).style.backgroundColor = "red";
    }else{
        document.getElementById(n).style.backgroundColor = "#6f5193cf";
        document.getElementById(n).innerHTML = "";
        ...
        if(aux.includes("@") && aux.includes(".com")){
            ...
            document.getElementById("erroEmail").innerHTML = "Erro";
            document.getElementById(n).style.backgroundColor = "red"
        }
}
var senha;
...
function endereco(n){
    ...
    aux = aux.trim();
        if(aux == null || aux == ""){
            document.getElementById(n).placeholder = "Endereço necessário";
            document.getElementById(n).style.backgroundColor = "red";
        }else{
            document.getElementById(n).style.backgroundColor = "#6f5193cf";
            document.getElementById(n).innerHTML = "";
...
function registrar(){
    document.getElementById("ienviar").innerHTML = "REGISTRADO"
    document.getElementById("ienviar").style.fontSize = "25px";
}